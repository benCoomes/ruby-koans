...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Never, I think. But expressions including * can still fail to match.
  end
  ...
  #
  # Why?
  # Because given the option of including a character in the match or not, 
  # they always include the character. Ex: "abbb"[/ab*/] => "abbb" and not just "a"
  ...
  # A character class matches characters while alteration matches patterns. 
  # ------------------------------------------------------------------
