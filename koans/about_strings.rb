...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # += creates a new string object while << appends to an existing string object
    # << is likely more time and memory effecient.
    # but += has the benefit of immutability, when that matters
  end
