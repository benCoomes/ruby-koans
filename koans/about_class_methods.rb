...
class AboutClassMethods < Neo::Koan
  ...
  # I think they're both about equally readble for single methods. 
  # I'd prefer the second way for multiple methods, because it helps to group 
  # class methods logically and declarations are less verbose inside the 'class << self' block
  # So, I'd always use the second way for consistency's sake, unless there was
